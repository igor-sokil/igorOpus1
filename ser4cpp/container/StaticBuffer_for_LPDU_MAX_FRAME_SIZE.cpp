...
////    return rseq_t(this->buffer, LENGTH);
  RSeq_for_Uint16_t_in_RSeq_for_Uint16_tOver2(&rRSeq_for_Uint16_t, pStaticBuffer-> buffer, LPDU_MAX_FRAME_SIZE);
...
////    return this->as_seq().take(max_size);
  RSeq_for_Uint16_t temp1 = as_seq_in_StaticBuffer_for_LPDU_MAX_FRAME_SIZEOver1(pStaticBuffer);
...
////    return wseq_t(this->buffer, LENGTH);
  ...
  WSeq_for_Uint16_t_in_WSeq_for_Uint16_tOver2(&wWSeq_for_Uint16_t, pStaticBuffer-> buffer, LPDU_MAX_FRAME_SIZE);
...
////    return wseq_t(this->buffer, ser4cpp::min(LENGTH, max_size));
  WSeq_for_Uint16_t wWSeq_for_Uint16_t;
  WSeq_for_Uint16_t_in_WSeq_for_Uint16_tOver2(&wWSeq_for_Uint16_t, pStaticBuffer-> buffer, min_for_Uint16_t(LPDU_MAX_FRAME_SIZE, max_size));
  return wWSeq_for_Uint16_t;
}

uint16_t length_in_StaticBuffer_for_LPDU_MAX_FRAME_SIZE(void)
{
  return LPDU_MAX_FRAME_SIZE;
}
