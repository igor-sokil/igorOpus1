...
void Array__for__Node_for_CellAnalogRecord_in_Array__for__Node_for_CellAnalogRecordOver2(Array__for__Node_for_CellAnalogRecord *pArray__for__Node_for_CellAnalogRecord, uint32_t size)
{
  ...
  std::cout<<"Array__for__Node_for_CellAnalogRecord_in_Array__for__Node_for_CellAnalogRecordOver2_1"<<'\n';
  std::cout<<"*"<<getString_stack_info();
  std::cout<<"*Node_for_CellAnalogRecord buffer[SIZE_for_CellAnalogRecord]="<<(uint32_t)pArray__for__Node_for_CellAnalogRecord->buffer<<'\n';
  decrement_stack_info();
#endif
//    void HasLength_for_Uint32_t_in_HasLength_for_Uint32_tOver2(HasLength_for_Uint32_t *pHasLength, uint32_t length);
  HasLength_for_Uint32_t_in_HasLength_for_Uint32_tOver2(&(pArray__for__Node_for_CellAnalogRecord->hHasLength_for_Uint32_t), size);
}
...
void Array__for__Node_for_CellAnalogRecord_in_Array__for__Node_for_CellAnalogRecordOver1(Array__for__Node_for_CellAnalogRecord *pArray__for__Node_for_CellAnalogRecord)
{
  ...
  increment_stack_info();
  std::cout<<getString_stack_info();
  std::cout<<"Array__for__Node_for_CellAnalogRecord_in_Array__for__Node_for_CellAnalogRecordOver1_1"<<'\n';
  std::cout<<"*"<<getString_stack_info();
  std::cout<<"*Node_for_CellAnalogRecord buffer[SIZE_for_CellAnalogRecord]="<<(uint32_t)pArray__for__Node_for_CellAnalogRecord->buffer<<'\n';
  decrement_stack_info();
#endif
  for(int i=0; i<SIZE_for_CellAnalogRecord; i++)
  {
   Node_for_CellAnalogRecord_in_Node_for_CellAnalogRecord(&(pArray__for__Node_for_CellAnalogRecord->buffer[i]));
  }//for
//    void HasLength_for_Uint32_t_in_HasLength_for_Uint32_tOver2(HasLength_for_Uint32_t *pHasLength, uint32_t length);
  HasLength_for_Uint32_t_in_HasLength_for_Uint32_tOver2(&(pArray__for__Node_for_CellAnalogRecord->hHasLength_for_Uint32_t), 0);
}
...
//    uint32_t length_in_HasLength_for_Uint32_t(HasLength_for_Uint32_t *pHasLength);
  HasLength_for_Uint32_t_in_HasLength_for_Uint32_tOver2(&(pArray__for__Node_for_CellAnalogRecord->hHasLength_for_Uint32_t),
      length_in_HasLength_for_Uint32_t(&(pArray__for__Node_for_CellAnalogRecord->hHasLength_for_Uint32_t)));
////        for (W i = 0; i < copy.length(); ++i)
  for(uint32_t i = 0; i<length_in_HasLength_for_Uint32_t(&(copyEv->hHasLength_for_Uint32_t)); ++i)
////            buffer[i] = copy.buffer[i];
    (pArray__for__Node_for_CellAnalogRecord->buffer)[i] = (copyEv->buffer)[i];
}
...
{
  return index < (pArray__for__Node_for_CellAnalogRecord->hHasLength_for_Uint32_t).m_length;
}
