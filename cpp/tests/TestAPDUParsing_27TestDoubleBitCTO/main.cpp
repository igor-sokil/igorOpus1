...
{
qDebug()<<"REQUIRE(2 == mock.eventDoubleBinaries.size())";
 uint16_t size = mock->eventDoubleBinaries.size();
...
qDebug()<<"********SUITE('27TestDoubleBitCTO')********";
void validate(MockApduHeaderHandler*);
{
  std::string name("04 03 17 02 03 C1 07 00 05 41 09 00");       
ParseResult_uint8_t temp = TestComplex(name, validate);
qDebug()<<"TestComplex('04 03 17 02 03 C1 07 00 05 41 09 00', ParseResult::OK, 1, [](MockApduHeaderHandler& mock)";
