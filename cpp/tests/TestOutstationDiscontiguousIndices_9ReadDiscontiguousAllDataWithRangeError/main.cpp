...
qDebug()<<"********SUITE('9ReadDiscontiguousAllDataWithRangeError')********";
////    REQUIRE(QueryDiscontiguousBinary("C0 01 01 02 00 02 05") == "C0 81 80 04 01 02 00 02 02 81 01 02 00 04 05 01 02");

 std::string request("C0 01 01 02 00 02 05");       
 std::string response = QueryDiscontiguousBinary(request);
qDebug()<<"REQUIRE(QueryDiscontiguousBinary('C0 01 01 02 00 02 05') == 'C0 81 80 04 01 02 00 02 02 81 01 02 00 04 05 01 02')";
