...
qDebug()<<"********SUITE('16WriteTimeDateLAN')********";
...
////    t.AdvanceTime(TimeDuration::Milliseconds(10));
    TimeDuration td = Milliseconds_in_TimeDuration_static(10);
    AdvanceTime_in_OutstationTestObject(&t, &td);

    std::string name("C0 18");       
...
std::cout << "temp= " << temp<<'\n';
    ...
    TimeDuration td = Milliseconds_in_TimeDuration_static(20);
    AdvanceTime_in_OutstationTestObject(&t, &td);
...
qDebug()<<"REQUIRE(t.application->timestamps.front().msSinceEpoch == 1254)";
