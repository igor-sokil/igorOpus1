...
#ifndef OPENDNP3_MRZSFRAMESINK_H
#define OPENDNP3_MRZSFRAMESINK_H

////#include <opendnp3/gen/LinkFunction.h>

////#include "dnp3Mrzss/DataSink.h"
...
////class MrzsFrameSink : public opendnp3::ILinkSession
typedef struct
{
...
///void Update_in_MrzsFrameSink(MrzsFrameSink *pMrzsFrameSink, LinkFunction_uint8_t aCode, boolean aIsMaster, uint16_t aSrc, uint16_t aDest);
///void AddAction_in_MrzsFrameSink(MrzsFrameSink *pMrzsFrameSink, const std::function<void()>& fun);

boolean CheckLast_in_MrzsFrameSink(MrzsFrameSink *pMrzsFrameSink, LinkFunction_uint8_t func, boolean aIsMaster, uint16_t aDest, uint16_t aSrc);
boolean CheckLastWithFCB_in_MrzsFrameSink(MrzsFrameSink *pMrzsFrameSink, LinkFunction_uint8_t func, boolean aIsMaster, boolean aFcb, uint16_t aDest, uint16_t aSrc);
boolean CheckLastWithDFC_in_MrzsFrameSink(MrzsFrameSink *pMrzsFrameSink,
