...
qDebug()<<"********SUITE('11SelectOperateCROBSameSequenceNumber')********";
...
qDebug()<<"REQUIRE(t.lower->PopWriteAsHex() == 'C1 81 80 00 0C 01 17 01 03 01 01 01 00 00 00 01 00 00 00 00')";
std::cout << "temp= " << temp<<'\n';
...
qDebug()<<"REQUIRE(2 == t.cmdHandler->NumInvocations())";
std::cout << "t.cmdHandler->NumInvocations()= " << NumInvocations_in_MockCommandHandler(&(t.cmdHandler))<<'\n';
