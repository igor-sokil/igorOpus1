...
qDebug()<<"********SUITE('2Formats two-byte qualifier properly if enough space is available')********";
...
std::cout<<"REQUIRE(header.Write(writer, IndexQualifierMode::always_two_bytes))"<<'\n';
