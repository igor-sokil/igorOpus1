...
*    *pEventBufferConfig->maxDoubleBinaryEvents=5
*    *pEventBufferConfig->maxAnalogEvents= 5
*    *pEventBufferConfig->maxCounterEvents= 5
*    *pEventBufferConfig->maxBinaryOutputStatusEvents= 5
*    *pEventBufferConfig->maxAnalogOutputStatusEvents= 5
*    *pEventBufferConfig->maxOctetStringEvents= 5
...
*        *ret |= AppControlField_UNS_MASK
        ...
        *uint8_t seq =0
        ...
        {SetControl_in_APDUWrapper1
@@@@        *write_uint8=6411052->240
        }SetControl_in_APDUWrapper_

        {SetFunction_in_APDUWrapper1
@@@@        *write_uint8=6411053->130
        }SetFunction_in_APDUWrapper_

        {SetIIN_in_APDUResponse1
@@@@        *write_uint8=6411054->128
@@@@        *write_uint8=6411055->0
        }SetIIN_in_APDUResponse_
    }NullUnsolicited_in_APDUBuilders_static_
*    **inspect_IINField**
*    *uint8_t LSB= 128
...
*    *ret |= AppControlField_UNS_MASK
    ...
    *uint8_t seq =0
    ...
    {SetControl_in_APDUWrapper1
@@@@    *write_uint8=6411004->208
    }SetControl_in_APDUWrapper_

    {SetFunction_in_APDUWrapper1
@@@@    *write_uint8=6411005->0
    }SetFunction_in_APDUWrapper_
...
*        *DNPTime timeDNPTime.quality= 141
