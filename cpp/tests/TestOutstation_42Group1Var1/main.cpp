...
qDebug()<<"********SUITE('42Group1Var1 is promoted to Group1Var2 if quality not online')********";
...
DatabaseConfig database = binary_input_in_DatabaseHelpers(2);
...
qDebug()<<"REQUIRE(t.lower->PopWriteAsHex() == 'C0 81 80 00 01 02 00 00 01 02 02')";
std::cout << "temp= " << temp<<'\n';
