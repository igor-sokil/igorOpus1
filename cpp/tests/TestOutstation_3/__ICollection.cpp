...
void __ForeachItem_in_ICollection_Indexed_for_TimeAndInterval(
    __ICollection_Indexed_for_TimeAndInterval *pICollection_Indexed_for_TimeAndInterval, 
    void (*fun)(Indexed_for_TimeAndInterval* item))
{
...
{
  ((__FunctorVisitor__for__Indexed_for_TimeAndInterval*)pFunctorVisitor__for__Indexed_for_TimeAndInterval)->
  Fun(value);
}
...
//--------------------------------ICollection_Indexed_for_TimeAndInterval--------------------------------
/*
void __FunctorVisitor__for__Indexed_for_TimeAndInterval_in_FunctorVisitor__for__Indexed_for_TimeAndInterval(FunctorVisitor__for__Indexed_for_TimeAndInterval *pFunctorVisitor__for__Indexed_for_TimeAndInterval,
