...
@@@@        *LinkFunction_PRI_TEST_LINK_STATES
            ...
            {OnTestLinkStatus_in_SLLS_NotReset1
*            *SIMPLE_LOG_BLOCK(ctx.logger, flags::WARN, 'TestLinkStatus ignored')
            ...
            }OnTestLinkStatus_in_SLLS_NotReset_
...
@@@@                *LinkFunction_PRI_TEST_LINK_STATES
                    ...
                    {OnTestLinkStatus_in_SLLS_Reset1
*                    *ctx->nextReadFCB= 1
*                    *boolean fcb= 1
*                    *uint16_t source= 1024
...
{BeginTransmit_in_LinkLayerTest1
                    ...
                    }OnTestLinkStatus_in_SLLS_Reset1_
                }OnFrame_in_LinkContext6_
...
std::string tmpStr =05 64 05 80 00 04 01 00 6D C7
