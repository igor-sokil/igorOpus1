********SUITE('3ValidatesMasterOutstationBit')********
...
*        **inspect_RSeq**
*        ***SIMPLE_LOG_BLOCK(logger, flags::ERR, 'Outstation frame received for outstation')***
        }OnFrame_in_LinkContext2_
    }OnFrame_in_LinkLayer_
}OnFrame_in_LinkLayerTest_
REQUIRE(t.link.GetStatistics().numBadMasterBit == 1)
t.link.GetStatistics().numBadMasterBit = 1
