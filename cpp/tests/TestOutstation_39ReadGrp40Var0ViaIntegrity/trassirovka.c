********SUITE('39ReadGrp40Var0ViaIntegrity')********
...
*                                                        *GroupVariation_uint16_t enumeration= 2800
...
*                                                *record->gGroupVariationRecord.group=40
*                                                *record->gGroupVariationRecord.variation=0
*                                                *record->gGroupVariationRecord.enumeration=2800
*                                                *IAPDUHandler* pHandler=0
...
*                                        *map.map.size()= 1
                                            ...
                                            get_for_AnalogOutputStatusSpec_in_StaticWriters_static1
*                                            *StaticAnalogOutputStatusVariation_Group40Var1
...
*                                            *id.variation= 1
*                                            *qc= 0
@@@@                                            *write_in_UInt8_static = 6421366->40
@@@@                                            *write_in_UInt8_static = 6421367->1
@@@@                                            *write_in_UInt8_static = 6421368->0

                                            RangeWriteIterator_for_UInt8_AnalogOutputStatus_in_RangeWriteIterator_for_UInt8_AnalogOutputStatusOver2_1
@@@@                                        *write_in_UInt8_static = 6421369->0
@@@@                                        *write_in_UInt8_static = 6421371->2
@@@@                                        *write_in_UInt32_static = 6421372->0

                                            RangeWriteIterator_for_UInt8_AnalogOutputStatus_destr_RangeWriteIterator_for_UInt8_AnalogOutputStatus1
...
response= C0 81 80 00 28 01 00 00 00 02 00 00 00 00
temp=     C0 81 80 00 28 01 00 00 00 02 00 00 00 00
