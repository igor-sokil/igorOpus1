...
void TestStaticCounter(StaticCounterVariation variation, uint32_t value, std::string& response);
 ...
 std::string response("C0 81 80 00 14 01 00 00 00 01 05 00 00 00");
 TestStaticCounter(StaticCounterVariation_Group20Var1, 5, response);
