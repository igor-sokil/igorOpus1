...
*                                                    *id.variation= 5
*                                                    *qc= 0
@@@@                                                    *write_in_UInt8_static = 6421542->21
@@@@                                                    *write_in_UInt8_static = 6421543->5
@@@@                                                    *write_in_UInt8_static = 6421544->0

                                                    {RangeWriteIterator_for_UInt8_FrozenCounter_in_RangeWriteIterator_for_UInt8_FrozenCounterOver2_1
@@@@                                                    *write_in_UInt8_static = 6421545->0
...
@@@@                                                    *write_in_UInt8_static = 6421547->1
@@@@                                                    *write_in_UInt32_static = 6421548->0
@@@@                                                    *write_in_UInt48_static = 6421552->0
...
@@@@                                            *write_in_UInt8_static = 6421546->0
...
*                                        *uint8_t LSB= 129
*                                        *uint8_t MSB= 0
*                                        CheckForBroadcastConfirmation_in_OContext5
...
temp2= C1 81 81 00 15 05 00 00 00 01 00 00 00 00 00 00 00 00 00 00
...
@@@@                                                    *write_in_UInt8_static = 6421547->1
@@@@                                                    *write_in_UInt32_static = 6421548->41
@@@@                                                    *write_in_UInt48_static = 6421552->240607800000
                                                    }Write_in_RangeWriteIterator_for_UInt8_FrozenCounter1_
                                                }LoadWithRangeIterator_FrozenCounterSpec_for_UInt8_in_StaticWriters4_
...
temp5= C4 81 81 00 15 05 00 00 00 01 29 00 00 00 C0 AA 57 05 38 00
...
*                                            *id.variation= 1
*                                            *qc= 0
@@@@                                            *write_in_UInt8_static = 6421542->20
@@@@                                            *write_in_UInt8_static = 6421543->1
@@@@                                            *write_in_UInt8_static = 6421544->0
...
REQUIRE(t.lower->PopWriteAsHex() == 'C5 81 80 00 14 01 00 00 00 01 00 00 00 00')
