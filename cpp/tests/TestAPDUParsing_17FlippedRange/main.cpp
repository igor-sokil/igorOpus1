...
qDebug()<<"********SUITE('15FlippedRange')********";

  std::string name("01 02 00 05 03");       
ParseResult_uint8_t temp = TestComplex(name, NULL);
qDebug()<<"TestSimple('01 02 00 05 03', ParseResult::BAD_START_STOP, 0)";
qDebug()<<"ParseResult_uint8_t result= "<<temp;
qDebug()<<"ParseResult::BAD_START_STOP= "<<ParseResult_BAD_START_STOP;

  std::string name1("01 02 00 FF 00");       
 temp = TestComplex(name1, NULL);
qDebug()<<"TestSimple('01 02 00 FF 00', ParseResult::BAD_START_STOP, 0)";
qDebug()<<"ParseResult_uint8_t result= "<<temp;
qDebug()<<"ParseResult::BAD_START_STOP= "<<ParseResult_BAD_START_STOP;
/*
  std::string name("01 02 00 01 04 FF FF FF");       
