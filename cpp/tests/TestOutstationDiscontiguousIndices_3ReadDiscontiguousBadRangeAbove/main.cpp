...
qDebug()<<"********SUITE('3ReadDiscontiguousBadRangeAbove')********";
/////    REQUIRE(QueryDiscontiguousBinary("C0 01 01 02 00 06 09") == "C0 81 80 04");

 std::string request("C0 01 01 02 00 06 09");       
 std::string response = QueryDiscontiguousBinary(request);
qDebug()<<"REQUIRE(QueryDiscontiguousBinary('C0 01 01 02 00 06 09') == 'C0 81 80 04')";
