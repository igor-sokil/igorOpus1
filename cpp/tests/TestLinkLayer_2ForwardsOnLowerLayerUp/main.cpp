...
qDebug()<<"********SUITE('2ForwardsOnLowerLayerUp')********";
    LinkLayerTest t;
...
boolean tempBool = IsOnline_in_MockTransportLayer(&(t.upper));
...
tempBool = OnLowerLayerUp_in_LinkLayer(&(t.link));
qDebug()<<"REQUIRE(t.link.OnLowerLayerUp())";
qDebug()<<"boolean tempBool= "<<tempBool;

////    REQUIRE(t.upper->IsOnline());
 tempBool = IsOnline_in_MockTransportLayer(&(t.upper));
qDebug()<<"REQUIRE(t.upper->IsOnline())";
qDebug()<<"boolean tempBool= "<<tempBool;

////    REQUIRE_FALSE(t.link.OnLowerLayerUp());
tempBool = OnLowerLayerUp_in_LinkLayer(&(t.link));
qDebug()<<"REQUIRE_FALSE(t.link.OnLowerLayerUp())";
qDebug()<<"boolean tempBool= "<<tempBool;
