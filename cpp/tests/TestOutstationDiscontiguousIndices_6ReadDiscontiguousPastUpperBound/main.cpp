...
qDebug()<<"********SUITE('6ReadDiscontiguousPastUpperBound')********";
////    REQUIRE(QueryDiscontiguousBinary("C0 01 01 02 00 05 06") == "C0 81 80 04 01 02 00 05 05 02");

 std::string request("C0 01 01 02 00 05 06");       
 std::string response = QueryDiscontiguousBinary(request);
qDebug()<<"REQUIRE(QueryDiscontiguousBinary('C0 01 01 02 00 05 06') == 'C0 81 80 04 01 02 00 05 05 02')";
