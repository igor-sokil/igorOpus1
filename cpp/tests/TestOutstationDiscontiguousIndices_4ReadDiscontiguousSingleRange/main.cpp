...
qDebug()<<"********SUITE('4ReadDiscontiguousSingleRange')********";
////    REQUIRE(QueryDiscontiguousBinary("C0 01 01 02 00 02 02") == "C0 81 80 00 01 02 00 02 02 81");

 std::string request("C0 01 01 02 00 02 02");       
 std::string response = QueryDiscontiguousBinary(request);
qDebug()<<"REQUIRE(QueryDiscontiguousBinary('C0 01 01 02 00 02 02') == 'C0 81 80 00 01 02 00 02 02 81')";
