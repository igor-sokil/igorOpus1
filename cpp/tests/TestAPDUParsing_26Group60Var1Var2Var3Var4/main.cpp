...
qDebug()<<"********SUITE('26Group60Var1Var2Var3Var4')********";
void validate(MockApduHeaderHandler*);
{
  std::string name("3C 01 06 3C 02 06 3C 03 06 3C 04 06");       
ParseResult_uint8_t temp = TestComplex(name, validate);
qDebug()<<"TestComplex('3C 01 06 3C 02 06 3C 03 06 3C 04 06', ParseResult::OK, 4, [](MockApduHeaderHandler& mock)";
