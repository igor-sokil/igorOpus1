...
qDebug()<<"********SUITE('32Group43Var1CountWithAllIndexSizes')********";
void validate(MockApduHeaderHandler*);
{
  std::string name("2B 01 17 01 09 01 32 00 00 00");       
ParseResult_uint8_t temp = TestComplex(name, validate);
qDebug()<<"TestComplex('2B 01 17 01 09 01 32 00 00 00', ParseResult::OK, 1, [](MockApduHeaderHandler& mock)";
qDebug()<<"ParseResult_uint8_t result= "<<temp;
}
{
  std::string name("2B 01 28 01 00 09 00 01 32 00 00 00");       
ParseResult_uint8_t temp = TestComplex(name, validate);
qDebug()<<"TestComplex('2B 01 28 01 00 09 00 01 32 00 00 00', ParseResult::OK, 1, [](MockApduHeaderHandler& mock)";
qDebug()<<"ParseResult_uint8_t result= "<<temp;
}
