...
@@@@                *read_in_UInt8_static = 6421441<-1
...
*                    *GroupVariation_uint16_t enumeration= 3301
...
@@@@                        *GroupVariation_Group51Var1

                            Process_in_CountParser1
                        }ParseCountOfObjects_in_CountParser_static3_
...
@@@@                        *GroupVariation_Group51Var1
                            ...
                            Process_in_CountParser1
                                ...
                                OnHeader_CountHeader_for_Group51Var1_in_IAPDUHandler1
                                ...
                                OnHeader_CountHeader_for_Group51Var1_in_IAPDUHandler_
                        }ParseCountOfObjects_in_CountParser_static3_
*                    *ParseHeader_in_CountParser_static3
*                    *ParseResult_uint8_t temp =0
                    }ParseHeader_in_CountParser_static1_
...
*                            **inspect_DNPTime**
*                            @*uint64_t value= 7
*                            @*TimestampQuality_uint8_t quality= 1
