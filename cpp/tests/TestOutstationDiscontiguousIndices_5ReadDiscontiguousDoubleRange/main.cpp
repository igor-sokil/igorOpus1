...
qDebug()<<"********SUITE('5ReadDiscontiguousDoubleRange')********";
////    REQUIRE(QueryDiscontiguousBinary("C0 01 01 02 00 04 05") == "C0 81 80 00 01 02 00 04 05 01 02");

 std::string request("C0 01 01 02 00 04 05");       
 std::string response = QueryDiscontiguousBinary(request);
qDebug()<<"REQUIRE(QueryDiscontiguousBinary('C0 01 01 02 00 04 05') == 'C0 81 80 00 01 02 00 04 05 01 02')";
