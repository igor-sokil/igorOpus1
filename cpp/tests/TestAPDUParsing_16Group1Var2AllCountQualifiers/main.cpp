...
qDebug()<<"********SUITE('16Group1Var2AllCountQualifiers')********";
{
  std::string name("01 02 00 00 01 81 01");       
ParseResult_uint8_t temp = TestComplex(name, validate);
qDebug()<<"TestComplex('01 02 00 00 01 81 01', ParseResult::OK, 1, [](MockApduHeaderHandler& mock)";
qDebug()<<"ParseResult_uint8_t result= "<<temp;
}
{
  std::string name("01 02 01 00 00 01 00 81 01");       
ParseResult_uint8_t temp = TestComplex(name, validate);
qDebug()<<"TestComplex('01 02 01 00 00 01 00 81 01', ParseResult::OK, 1, [](MockApduHeaderHandler& mock)";
qDebug()<<"ParseResult_uint8_t result= "<<temp;
}
{
  std::string name("01 02 09 02 00 00 00 81 01");       
ParseResult_uint8_t temp = TestComplex(name, NULL);
qDebug()<<"TestComplex('01 02 09 02 00 00 00 81 01', ParseResult::UNKNOWN_QUALIFIER, 0";
qDebug()<<"ParseResult_uint8_t result= "<<temp;
qDebug()<<"ParseResult::UNKNOWN_QUALIFIER= "<<ParseResult_UNKNOWN_QUALIFIER;
}
/*
