...
qDebug()<<"********SUITE('16SelectOperateGroup41Var1')********";
...
////    t.OnTxReady();
    ...
    std::string name("C0 03 29 01 17 01 03 00 00 00 00 00");       
    SendToOutstation_in_OutstationTestObject(&t, name);  

    std::string temp = PopWriteAsHex_in_MockLowerLayer(&(t.lower));

qDebug()<<"REQUIRE(t.lower->PopWriteAsHex() == 'C0 81 80 00 29 01 17 01 03 00 00 00 00 00')";
std::cout << "temp= " << temp<<'\n';
...
////    t.OnTxReady();
    std::string name("C1 04 29 01 17 01 03 00 00 00 00 00");       
    SendToOutstation_in_OutstationTestObject(&t, name);  

    std::string temp = PopWriteAsHex_in_MockLowerLayer(&(t.lower));

qDebug()<<"REQUIRE(t.lower->PopWriteAsHex() == 'C1 81 80 00 29 01 17 01 03 00 00 00 00 00')";
std::cout << "temp= " << temp<<'\n';
