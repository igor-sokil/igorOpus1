...
qDebug()<<"********SUITE('3CROBWithQUSetReturnsNotSupported')********";
...
////    t.SendToOutstation("C0 03 0C 01 17 01 03 51 01 01 00 00 00 01 00 00 00 00");
    ...
    std::string name("C0 03 0C 01 17 01 03 51 01 01 00 00 00 01 00 00 00 00");       
    SendToOutstation_in_OutstationTestObject(&t, name);  

    std::string temp = PopWriteAsHex_in_MockLowerLayer(&(t.lower));

qDebug()<<"REQUIRE(t.lower->PopWriteAsHex() == 'C0 81 80 04 0C 01 17 01 03 51 01 01 00 00 00 01 00 00 00 04')";
std::cout << "temp= " << temp<<'\n';
...
qDebug()<<"REQUIRE(t.cmdHandler->NumInvocations() == 0)";
