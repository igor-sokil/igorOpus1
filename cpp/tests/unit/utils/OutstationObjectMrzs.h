 ...
 */
#ifndef OPENDNP3_OUTSTATION_OBJECT_MRZS_H
#define OPENDNP3_OUTSTATION_OBJECT_MRZS_H
...
////class OutstationObjectMrzs
typedef struct
{

////public:
////    OutstationObjectMrzs(const opendnp3::OutstationConfig& config,
...
//  MockLowerLayer lower_in_OutstationObjectMrzs;
  MrzsLowerLayer lower_in_OutstationObjectMrzs;
...
////    const std::shared_ptr<MockOutstationApplication> application;
  ...
  OContext context;
} OutstationObjectMrzs;

//   void OutstationObjectMrzs_in_OutstationObjectMrzs(OutstationConfig* config,
//                                                     DatabaseConfig* db_config);// = opendnp3::DatabaseConfig());
void OutstationObjectMrzs_in_OutstationObjectMrzs(OutstationObjectMrzs *pOutstationObjectMrzs, OutstationConfig* config,
    DatabaseConfig* db_config);// = opendnp3::DatabaseConfig());
