...
TEST_CASE(SUITE("5TimeoutDuringStartup"))
{
    MasterParams params;
    MasterTestFixture t(params);
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("6SolicitedResponseTimeout"))
{
...
TEST_CASE(SUITE("7Retries use exponential backoff"))
{
    MasterParams params;
    params.disableUnsolOnStartup = false;
    MasterTestFixture t(params);
...
TEST_CASE(SUITE("8AllObjectsScan"))
{
    MasterTestFixture t(NoStartupTasks());
...
TEST_CASE(SUITE("9ClassScanCanRepeat"))
{
...
TEST_CASE(SUITE("10SolicitedResponseLayerDown"))
{
    MasterTestFixture t(NoStartupTasks());
    auto scan = t.context->AddClassScan(ClassField::AllClasses(), TimeDuration::Seconds(5), t.meas);
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("11SolicitedMultiFragResponse"))
{
...
TEST_CASE(SUITE("13ParsesOctetStringResponseWithFiveCharacters"))
{
    MasterTestFixture t(NoStartupTasks());
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("14ParsesOctetStringResponseSizeOfOne"))
{
    MasterTestFixture t(NoStartupTasks());
...
TEST_CASE(SUITE("15ParsesGroup2Var3Correctly"))
{
    auto config = NoStartupTasks();
...
TEST_CASE(SUITE("16ParsesGroup2Var3TimeQualityCorrectly"))
{
    auto config = NoStartupTasks();
    config.startupIntegrityClassMask = ClassField(~0);
    MasterTestFixture t(config);
...
TEST_CASE(SUITE("17ParsesGroup50Var4"))
{
    auto config = NoStartupTasks();
    config.startupIntegrityClassMask = ClassField(~0);
    MasterTestFixture t(config);
...
TEST_CASE(SUITE("18RestartViaNullUnsol"))
{
    MasterParams params;
...
TEST_CASE(SUITE("19DisableAutomatedRestartClear"))
{
    MasterParams params;
...
TEST_CASE(SUITE("20RestartDuringStartup"))
{
...
TEST_CASE(SUITE("21performs non-LAN time synchronization"))
{
...
TEST_CASE(SUITE("22performs LAN time synchronization"))
{
    auto params = NoStartupTasks();
...
TEST_CASE(SUITE("23ReceiveCTOSynchronized"))
{
    auto params = NoStartupTasks();
    MasterTestFixture t(params);
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("24ReceiveCTOUnsynchronized"))
{
    auto params = NoStartupTasks();
    MasterTestFixture t(params);
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("25ReceiveIINinResponses"))
{
    auto params = NoStartupTasks();
    MasterTestFixture t(params);
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("26ReceiveIINUnsol"))
{
    auto params = NoStartupTasks();
    MasterTestFixture t(params);
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("27EventScanOnEventsAvailableIIN"))
{
    auto params = NoStartupTasks();
...
TEST_CASE(SUITE("28AdhocScanWorksWithUnsolicitedDisabled"))
{
    MasterParams params = NoStartupTasks();
...
TEST_CASE(SUITE("29AdhocScanFailsImmediatelyIfMasterOffline"))
{
    MasterParams params = NoStartupTasks();
    MasterTestFixture t(params);
...
TEST_CASE(SUITE("30MasterWritesTimeAndInterval"))
{
    MasterParams params = NoStartupTasks();
    MasterTestFixture t(params);
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("31Cold restart fails with empty response"))
{
    MasterParams params = NoStartupTasks();
    MasterTestFixture t(params);
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("32Warm restart fails with empty response"))
{
    MasterParams params = NoStartupTasks();
    MasterTestFixture t(params);
    t.context->OnLowerLayerUp();
...
TEST_CASE(SUITE("33IntegrityPollOnBufferOverflowIIN"))
{
    MasterParams params;
    params.disableUnsolOnStartup = false;
    params.unsolClassMask = ClassField::None();
