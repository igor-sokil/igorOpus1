...
qDebug()<<"********SUITE('53ReadGrp40Var1')********";

 std::string name("C0 81 80 00 28 01 00 00 00 01 64 00 00 00");   
 TestStaticAnalogOutputStatus(StaticAnalogOutputStatusVariation_Group40Var1, 100.0, name);
