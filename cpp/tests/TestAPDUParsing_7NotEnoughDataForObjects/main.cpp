...
qDebug()<<"TestSimple('01 02 00 01 04 FF FF FF', ParseResult::NOT_ENOUGH_DATA_FOR_OBJECTS, 0)";
...
/*
qDebug()<<"TestSimple('02 02 AB', ParseResult::UNKNOWN_QUALIFIER, 0)";

  std::string name("02 02 AB");       
