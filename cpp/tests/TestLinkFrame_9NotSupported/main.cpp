...
RSeq_for_Uint16_t wrapper = FormatNotSupported_in_LinkFrame_static(
  &writeTo, false, true, 1, 1024);//, Logger* pLogger);
...
////    REQUIRE(HexConversions::to_hex(wrapper) == RepairCRC("05 64 05 9B 01 00 00 04 E9 21"));
  std::string name1("05 64 05 1F 01 00 00 04 28 5A");       
