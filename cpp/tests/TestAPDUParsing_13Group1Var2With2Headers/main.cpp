...
qDebug()<<"********SUITE('13Group1Var2With2Headers')********";
void validate(MockApduHeaderHandler*);

  std::string name("01 02 00 01 01 81 01 02 00 02 03 81 81");       
ParseResult_uint8_t temp = TestComplex(name, NULL);
qDebug()<<"TestComplex('01 02 00 01 01 81 01 02 00 02 03 81 81', ParseResult::OK, 2,[](MockApduHeaderHandler& mock) { REQUIRE(2 == mock.records.size()); })";
