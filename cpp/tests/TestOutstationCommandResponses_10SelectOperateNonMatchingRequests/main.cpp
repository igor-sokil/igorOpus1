...
qDebug()<<"********SUITE('10SelectOperateNonMatchingRequests')********";
...
{
    std::string name("C1 04 0C 01 17 01 04 01 01 01 00 00 00 01 00 00 00 00");       
    SendToOutstation_in_OutstationTestObject(&t, name);  

    std::string temp = PopWriteAsHex_in_MockLowerLayer(&(t.lower));

qDebug()<<"REQUIRE(t.lower->PopWriteAsHex() == 'C1 81 80 00 0C 01 17 01 04 01 01 01 00 00 00 01 00 00 00 02')";
std::cout << "temp= " << temp<<'\n';
