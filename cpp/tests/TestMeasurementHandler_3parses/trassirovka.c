...
*                    *GroupVariation_uint16_t enumeration= 201
...
*                    *record.group= 2
*                    *record.variation= 1
*                    *record.enumeration= 513
*                    *record.GetQualifierCode()= 23

                    ParseCountOfObjects_in_CountIndexParser_static1
*                    *record->gGroupVariationRecord.enumeration= 201
@@@@                    *GroupVariation_Group2Var1
...
@@@@                    *GroupVariation_Group2Var1
                    ...
                    Process_in_CountIndexParser1
                        ...
                        ReadTarget_in_Group2Var1_static1

                        Read_in_Group2Var1_static1
*                        *output->flags= 0
