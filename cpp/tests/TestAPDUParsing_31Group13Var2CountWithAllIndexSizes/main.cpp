...
qDebug()<<"********SUITE('31Group13Var2CountWithAllIndexSizes')********";
void validate(MockApduHeaderHandler*);
{
  std::string name("0D 02 17 01 09 81 88 6E D0 92 4A 01");       
ParseResult_uint8_t temp = TestComplex(name, validate);
qDebug()<<"TestComplex('0D 02 17 01 09 81 88 6E D0 92 4A 01', ParseResult::OK, 1, [](MockApduHeaderHandler& mock)";
