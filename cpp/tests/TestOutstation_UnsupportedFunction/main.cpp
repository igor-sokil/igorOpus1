...
////    t.SendToOutstation("C0 10");
    std::string name("C0 10");                    // func = initialize application (16)
    SendToOutstation_in_OutstationTestObject(&t, name);                        // func = initialize application (16)
