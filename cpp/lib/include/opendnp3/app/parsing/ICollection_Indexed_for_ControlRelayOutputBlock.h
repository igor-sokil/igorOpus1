...
////public:
  ...
  void* pParentPointer_in_IVisitor__for__Indexed_for_ControlRelayOutputBlock;
} IVisitor__for__Indexed_for_ControlRelayOutputBlock;

void* getParentPointer_in_IVisitor__for__Indexed_for_ControlRelayOutputBlock(IVisitor__for__Indexed_for_ControlRelayOutputBlock*);
void  setParentPointer_in_IVisitor__for__Indexed_for_ControlRelayOutputBlock(IVisitor__for__Indexed_for_ControlRelayOutputBlock*, void*);
...
////public:
   ...
   */
  void (*pForeach_in_ICollection_Indexed_for_ControlRelayOutputBlock)(void*, IVisitor__for__Indexed_for_ControlRelayOutputBlock* visitor);// const = 0;
...
void* getParentPointer_in_ICollection_Indexed_for_ControlRelayOutputBlock(ICollection_Indexed_for_ControlRelayOutputBlock*);
void  setParentPointer_in_ICollection_Indexed_for_ControlRelayOutputBlock(ICollection_Indexed_for_ControlRelayOutputBlock*, void*);
  uint16_t Count_in_ICollection_Indexed_for_ControlRelayOutputBlock(ICollection_Indexed_for_ControlRelayOutputBlock*);
  void     Foreach_in_ICollection_Indexed_for_ControlRelayOutputBlock(ICollection_Indexed_for_ControlRelayOutputBlock*, IVisitor__for__Indexed_for_ControlRelayOutputBlock* visitor);
...
void FunctorVisitor__for__Indexed_for_ControlRelayOutputBlock_in_FunctorVisitor__for__Indexed_for_ControlRelayOutputBlock(FunctorVisitor__for__Indexed_for_ControlRelayOutputBlock *pFunctorVisitor__for__Indexed_for_ControlRelayOutputBlock,
    void (*fun)(Indexed_for_ControlRelayOutputBlock* item));
void OnValue_in_FunctorVisitor__for__Indexed_for_ControlRelayOutputBlock_override(void *pFunctorVisitor__for__Indexed_for_ControlRelayOutputBlock, Indexed_for_ControlRelayOutputBlock *value);
//--------------------------------ICollection_Indexed_for_ControlRelayOutputBlock--------------------------------
