...
////public:
   ...
   * Visit all the elements of a collection
   */
  void (*pForeach_in_ICollection_Indexed_for_TimeAndInterval)(/*ICollection_Indexed_for_TimeAndInterval*/void*, IVisitor__for__Indexed_for_TimeAndInterval* visitor);// const = 0;
...
////public:
   ...
   * Visit all the elements of a collection
   */
  void (*pForeach_in_ICollection_for_Group50Var3)(/*ICollection_for_Group50Var3*/void*, IVisitor_for_Group50Var3* visitor);// const = 0;
