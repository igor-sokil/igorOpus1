...
{
//  TypedEventRecord_for_AnalogOutputStatusSpec_in_TypedEventRecord_for_AnalogOutputStatusSpec(&(pNode_TypedEventRecord_for_AnalogOutputStatusSpec->value));
...
{
//  TypedEventRecord_for_AnalogSpec_in_TypedEventRecord_for_AnalogSpec(&(pNode_TypedEventRecord_for_AnalogSpec->value));
...
{
//  TypedEventRecord_for_BinaryOutputStatusSpec_in_TypedEventRecord_for_BinaryOutputStatusSpec(&(pNode_TypedEventRecord_for_BinaryOutputStatusSpec->value));
...
{
//  TypedEventRecord_for_BinarySpec_in_TypedEventRecord_for_BinarySpec(&(pNode_TypedEventRecord_for_BinarySpec->value));
...
{
//  TypedEventRecord_for_CounterSpec_in_TypedEventRecord_for_CounterSpec(&(pNode_TypedEventRecord_for_CounterSpec->value));
...
{
//  TypedEventRecord_for_DoubleBitBinarySpec_in_TypedEventRecord_for_DoubleBitBinarySpec(&(pNode_TypedEventRecord_for_DoubleBitBinarySpec->value));
...
{
//  TypedEventRecord_for_FrozenCounterSpec_in_TypedEventRecord_for_FrozenCounterSpec(&(pNode_TypedEventRecord_for_FrozenCounterSpec->value));
...
{
//  TypedEventRecord_for_OctetStringSpec_in_TypedEventRecord_for_OctetStringSpec(&(pNode_TypedEventRecord_for_OctetStringSpec->value));
