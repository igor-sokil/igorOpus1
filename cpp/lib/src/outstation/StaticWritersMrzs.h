...
//typedef boolean  (* static_write_func_t_for_BinaryMrzs)(StaticDataMap_for_BinarySpec& map, HeaderWriter* writer);//указатель на ф-цию
...
typedef boolean  (* static_write_func_t_for_AnalogMrzs)(StaticDataMap_for_AnalogMrzs* map, HeaderWriter* writer);//указатель на ф-цию
