...
boolean HasAbsoluteTime(GroupVariation_uint16_t gv)
{
  switch(gv)
  {
    ...
    case(GroupVariation_Group43Var3):
        return true;
    case(GroupVariation_Group43Var4):
        return true;
    case(GroupVariation_Group43Var7):
        return true;
    case(GroupVariation_Group43Var8):
        return true;
...
boolean HasRelativeTime(GroupVariation_uint16_t gv)
{
  switch(gv)
  {
...
boolean HasFlags(GroupVariation_uint16_t gv)
{
  switch(gv)
  {
...
boolean IsEvent(GroupVariation_uint16_t gv)
{
  switch(gv)
  {
    case(GroupVariation_Group2Var1):
    ...
    case(GroupVariation_Group43Var1):
        return true;
    case(GroupVariation_Group43Var2):
        return true;
    case(GroupVariation_Group43Var3):
        return true;
    case(GroupVariation_Group43Var4):
        return true;
    case(GroupVariation_Group43Var5):
        return true;
    case(GroupVariation_Group43Var6):
        return true;
    case(GroupVariation_Group43Var7):
        return true;
    case(GroupVariation_Group43Var8):
