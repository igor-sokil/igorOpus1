...
* ѕозвол€ет задачам, требующим последовательного выполнени€, блокировать задачи с более низким приоритетом.
  *
  *  аждый главный сеанс инициализирует свои задачи с помощью Shared_ptr в TaskContext.
 *
 */
